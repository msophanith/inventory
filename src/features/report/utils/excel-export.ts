...
import { exportProductInToExcel } from './product-in-export';
import { exportNewProductToExcel } from './new-product-export';

export { exportReportToCsv, exportProductInToExcel, exportNewProductToExcel };
...
export async function exportReportToExcel(
  ...
  const productRows = productReports.map((p) => [
    ...
    p.quantityReturned,
    p.quantityDamaged,
    p.totalDamage ?? p.quantityDamaged * p.buyPrice,
    p.totalSales,
    p.totalCost,
    p.netMargin,
