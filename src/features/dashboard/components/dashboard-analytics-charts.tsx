      ...
      <div className='rounded-3xl border border-slate-200/80 bg-white p-5 sm:p-6 shadow-sm space-y-4'>
        <div className='flex items-center justify-between border-b border-slate-100 pb-3.5'>
          <div className='flex items-center gap-2.5'>
            ...
            <div>
              <h2 className='font-extrabold text-slate-900 text-base'>Stock Distribution</h2>
              <p className='text-xs text-slate-500 font-medium'>Catalog health ratio across stock levels</p>
            </div>
          </div>
